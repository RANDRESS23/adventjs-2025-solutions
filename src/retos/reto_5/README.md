## Reto #5: ⏱️ La cuenta atrás para el despegue - Nivel Fácil
...
- Convierte el formato elfo a un timestamp primero. El sufijo ```N```P indica la hora oficial del Polo Norte (sin husos horarios ni DST), así que puedes tratarlo como si fuera UTC.
